...
```sh
npm install git+ssh://git@github.com:stainless-sdks/postgrid-node.git
```
...
This can also be useful if you are getting the wrong TypeScript types for `Response` ([more details](https://github.com/stainless-sdks/postgrid-node/tree/main/src/_shims#readme)).
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/postgrid-node/issues) with questions, bugs, or suggestions.
...
- Deno v1.28.0 or higher, using `import PostGrid from "npm:postgrid"`.
- Bun 1.0 or later.
- Cloudflare Workers.
- Vercel Edge Runtime.
