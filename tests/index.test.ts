...
describe('instantiate client', () => {
  ...
  describe('baseUrl', () => {
    ...
    test('env variable', () => {
      ...
      const client = new PostGrid({ printMailAPIKey: 'My Print Mail API Key' });
  ...
  test('maxRetries option is correctly set', () => {
    const client = new PostGrid({ maxRetries: 4, printMailAPIKey: 'My Print Mail API Key' });
    expect(client.maxRetries).toEqual(4);

    // default
    const client2 = new PostGrid({ printMailAPIKey: 'My Print Mail API Key' });
...
describe('retries', () => {
  test('retry on timeout', async () => {
    ...
    const client = new PostGrid({ printMailAPIKey: 'My Print Mail API Key', timeout: 10, fetch: testFetch });
  ...
  test('retry on 429 with retry-after', async () => {
    ...
    const client = new PostGrid({ printMailAPIKey: 'My Print Mail API Key', fetch: testFetch });
