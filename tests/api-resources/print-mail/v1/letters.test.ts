...
describe('resource letters', () => {
  test('create: only required params', async () => {
    const responsePromise = client.printMail.v1.letters.create({
  ...
  test('create: required and optional params', async () => {
    const response = await client.printMail.v1.letters.create({
      from: {
  ...
  test('retrieve', async () => {
    const responsePromise = client.printMail.v1.letters.retrieve('id');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('list', async () => {
    const responsePromise = client.printMail.v1.letters.list();
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('list: request options and params are passed correctly', async () => {
    ...
    await expect(
      client.printMail.v1.letters.list(
  ...
  test('delete', async () => {
    const responsePromise = client.printMail.v1.letters.delete('id');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('retrieveURL', async () => {
    const responsePromise = client.printMail.v1.letters.retrieveURL('id');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
