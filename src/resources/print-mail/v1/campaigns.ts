...
export class Campaigns extends APIResource {
   ...
   * @example
   * ```ts
   * const campaign = await client.printMail.v1.campaigns.create(
   *   { mailingList: 'mailingList' },
   * );
   * ```
   */
  create(body: CampaignCreateParams, options?: RequestOptions): APIPromise<CampaignCreateResponse> {
    return this._client.post('/print-mail/v1/campaigns', { body, ...options });
  }
   ...
   * ```ts
   * const campaign =
   *   await client.printMail.v1.campaigns.retrieve('id');
   * ```
   */
   ...
   * @example
   * ```ts
   * const campaign = await client.printMail.v1.campaigns.update(
   *   'id',
   * );
   * ```
   */
   ...
   * for await (const campaignListResponse of client.printMail.v1.campaigns.list()) {
   *   // ...
   * }
   * ```
   */
  list(
    ...
    return this._client.getAPIList('/print-mail/v1/campaigns', List<CampaignListResponse>, {
      query,
      ...options,
    });
  }
   ...
   * @example
   * ```ts
   * const campaign = await client.printMail.v1.campaigns.delete(
   *   'id',
   * );
   * ```
   */
   ...
   * @example
   * ```ts
   * const response = await client.printMail.v1.campaigns.send(
   *   'id',
   * );
   * ```
   */
