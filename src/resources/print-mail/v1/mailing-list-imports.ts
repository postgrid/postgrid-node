...
export class MailingListImports extends APIResource {
   ...
   *   await client.printMail.v1.mailingListImports.create({
  ...
  create(
    ...
    return this._client.post('/print-mail/v1/mailing_list_imports', { body, ...options });
  }
   ...
   * ```ts
   * const mailingListImport =
   *   await client.printMail.v1.mailingListImports.retrieve(
   *     'id',
   *   );
   * ```
   */
   ...
   * ```ts
   * const mailingListImport =
   *   await client.printMail.v1.mailingListImports.update(
   *     'id',
   *     {
   ...
   * for await (const mailingListImportListResponse of client.printMail.v1.mailingListImports.list()) {
   *   // ...
   * }
   * ```
   */
  list(
    ...
    return this._client.getAPIList(
      ...
      List<MailingListImportListResponse>,
      { query, ...options },
    );
  }
   ...
   * ```ts
   * const mailingListImport =
   *   await client.printMail.v1.mailingListImports.delete('id');
   * ```
   */
