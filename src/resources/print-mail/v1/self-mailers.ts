...
export class SelfMailers extends APIResource {
   ...
   * ```ts
   * const selfMailer =
   *   await client.printMail.v1.selfMailers.create({
   *     from: 'contact_123',
   ...
   * ```ts
   * const selfMailer =
   *   await client.printMail.v1.selfMailers.retrieve('id');
   * ```
   */
   ...
   * for await (const selfMailerListResponse of client.printMail.v1.selfMailers.list()) {
   *   // ...
   * }
   * ```
   */
  list(
    ...
    return this._client.getAPIList('/print-mail/v1/self_mailers', List<SelfMailerListResponse>, {
      query,
      ...options,
    });
  }
   ...
   * ```ts
   * const selfMailer =
   *   await client.printMail.v1.selfMailers.delete('id');
   * ```
   */
   ...
   * ```ts
   * const response =
   *   await client.printMail.v1.selfMailers.retrieveURL('id');
   * ```
   */
