...
import { BankAccountsList } from '../../bank-accounts';
...
export class BankAccounts extends APIResource {
   ...
   * ```ts
   * const bankAccount =
   *   await client.printMail.v1.bankAccounts.create({
   ...
   * ```
   */
  create(body: BankAccountCreateParams, options?: RequestOptions): APIPromise<BankAccountsAPI.BankAccount> {
   ...
   * ```ts
   * const bankAccount =
   *   await client.printMail.v1.bankAccounts.retrieve('id');
   * ```
   */
  retrieve(id: string, options?: RequestOptions): APIPromise<BankAccountsAPI.BankAccount> {
   ...
   * for await (const bankAccount of client.printMail.v1.bankAccounts.list()) {
   *   // ...
   * }
   * ```
   */
  ...
  ): PagePromise<BankAccountsList, BankAccountsAPI.BankAccount> {
    return this._client.getAPIList('/print-mail/v1/bank_accounts', List<BankAccountsAPI.BankAccount>, {
      query,
      ...options,
    });
  }
   ...
   * ```ts
   * const bankAccount =
   *   await client.printMail.v1.bankAccounts.delete('id');
   * ```
   */
