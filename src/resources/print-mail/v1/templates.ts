...
export class Templates extends APIResource {
   ...
   * @example
   * ```ts
   * const template = await client.printMail.v1.templates.create(
   *   {
   *     description: 'Test',
   ...
   * ```
   */
  create(body: TemplateCreateParams, options?: RequestOptions): APIPromise<TemplatesAPI.Template> {
   ...
   * ```ts
   * const template =
   *   await client.printMail.v1.templates.retrieve('id');
   * ```
   */
  retrieve(id: string, options?: RequestOptions): APIPromise<TemplatesAPI.Template> {
   ...
   * @example
   * ```ts
   * const template = await client.printMail.v1.templates.update(
   *   'id',
   *   {
   *     description: 'Test',
   *     html: '<b>Hello</b> {{to.firstName}}!',
  ...
  ): APIPromise<TemplatesAPI.Template> {
   ...
   * for await (const template of client.printMail.v1.templates.list()) {
   *   // ...
   * }
   * ```
   */
  list(
    ...
    options?: RequestOptions,
  ): PagePromise<TemplatesList, TemplatesAPI.Template> {
    return this._client.getAPIList('/print-mail/v1/templates', List<TemplatesAPI.Template>, {
      query,
      ...options,
    });
  }
   ...
   * @example
   * ```ts
   * const template = await client.printMail.v1.templates.delete(
   *   'id',
   * );
   * ```
   */
