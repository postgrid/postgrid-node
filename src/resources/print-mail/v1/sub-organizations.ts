...
export class SubOrganizations extends APIResource {
   ...
   *   await client.printMail.v1.subOrganizations.retrieve('id');
   * ```
   */
   ...
   * ```ts
   * const subOrganization =
   *   await client.printMail.v1.subOrganizations.update({
   *     countryCode: 'CA',
   ...
   * ```ts
   * const response =
   *   await client.printMail.v1.subOrganizations.retrieve();
   * ```
   */
  retrieve(
   ...
   * ```ts
   * const response =
   *   await client.printMail.v1.subOrganizations.retrieveUsers(
   *     'id',
   *   );
   * ```
   */
...
export interface SubOrganizationUpdateResponse {
   ...
   * The Sub-Organization object.
   */
  subOrganization: SubOrganizationUpdateResponse.SubOrganization;
...
export interface SubOrganizationRetrieveResponse {
  data: Array<SubOrganizationRetrieveResponse.Data>;
...
export namespace SubOrganizationRetrieveResponse {
  /**
   * The Sub-Organization object.
   */
...
export namespace SubOrganizationRetrieveUsersResponse {
  ...
  export interface SubOrganizationRetrieveUsersResponseItem {
     ...
     * A set of preferences for how a user should receive emails.
     */
    emailPreferences?: SubOrganizationRetrieveUsersResponseItem.EmailPreferences;
  ...
  export namespace SubOrganizationRetrieveUsersResponseItem {
    /**
     * A set of preferences for how a user should receive emails.
     */
    export interface EmailPreferences {
