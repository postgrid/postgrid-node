...
export class MailingLists extends APIResource {
   ...
   * ```ts
   * const mailingList =
   *   await client.printMail.v1.mailingLists.create({
  ...
  create(body: MailingListCreateParams, options?: RequestOptions): APIPromise<MailingListCreateResponse> {
    return this._client.post('/print-mail/v1/mailing_lists', { body, ...options });
  }
   ...
   * ```ts
   * const mailingList =
   *   await client.printMail.v1.mailingLists.retrieve('id');
   * ```
   */
   ...
   * ```ts
   * const mailingList =
   *   await client.printMail.v1.mailingLists.update('id', {
   ...
   * for await (const mailingListListResponse of client.printMail.v1.mailingLists.list()) {
   *   // ...
   * }
   * ```
   */
  list(
    ...
    return this._client.getAPIList('/print-mail/v1/mailing_lists', List<MailingListListResponse>, {
      query,
      ...options,
    });
  }
   ...
   * ```ts
   * const mailingList =
   *   await client.printMail.v1.mailingLists.delete('id');
   * ```
   */
   ...
   * ```ts
   * const response =
   *   await client.printMail.v1.mailingLists.jobs('id', {
  ...
  jobs(
    ...
    options?: RequestOptions,
  ): APIPromise<MailingListJobsResponse> {
 ...
 * Represents a mailing list.
 */
export interface MailingListJobsResponse {
  /**
   * A unique ID prefixed with mailing*list*
   */
  id: string;
   ...
   * A list of processing errors encountered, if any.
   */
  errors?: Array<MailingListJobsResponse.Error>;
...
export namespace MailingListJobsResponse {
  /**
   * Details of a specific error encountered during processing.
   */
  export interface Error {
