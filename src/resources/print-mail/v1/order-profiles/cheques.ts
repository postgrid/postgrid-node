...
export class Cheques extends APIResource {
   ...
   * ```ts
   * const cheque =
   *   await client.printMail.v1.orderProfiles.cheques.create({
   ...
   * ```ts
   * const cheque =
   *   await client.printMail.v1.orderProfiles.cheques.retrieve(
   *     'id',
   *   );
   * ```
   */
   ...
   * ```ts
   * const cheque =
   *   await client.printMail.v1.orderProfiles.cheques.update(
   *     'id',
   ...
   * for await (const chequeListResponse of client.printMail.v1.orderProfiles.cheques.list()) {
   *   // ...
   * }
   * ```
   */
  list(
    ...
    return this._client.getAPIList('/print-mail/v1/order_profiles/cheques', List<ChequeListResponse>, {
      query,
      ...options,
    });
  }
   ...
   * ```ts
   * const cheque =
   *   await client.printMail.v1.orderProfiles.cheques.delete(
   *     'id',
   *   );
   * ```
   */
