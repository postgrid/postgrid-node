...
export class Letters extends APIResource {
   ...
   * ```ts
   * const letter =
   *   await client.printMail.v1.orderProfiles.letters.create({
   *     size: 'us_letter',
   *     color: true,
   ...
   * ```ts
   * const letter =
   *   await client.printMail.v1.orderProfiles.letters.retrieve(
   *     'id',
   *   );
   * ```
   */
   ...
   * ```ts
   * const letter =
   *   await client.printMail.v1.orderProfiles.letters.update(
   *     'id',
   ...
   * for await (const letterListResponse of client.printMail.v1.orderProfiles.letters.list()) {
   *   // ...
   * }
   * ```
   */
  list(
    ...
    return this._client.getAPIList('/print-mail/v1/order_profiles/letters', List<LetterListResponse>, {
      query,
      ...options,
    });
  }
   ...
   * ```ts
   * const letter =
   *   await client.printMail.v1.orderProfiles.letters.delete(
   *     'id',
   *   );
   * ```
   */
