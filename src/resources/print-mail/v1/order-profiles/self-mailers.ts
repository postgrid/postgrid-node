...
export class SelfMailers extends APIResource {
   ...
   * ```ts
   * const selfMailer =
   *   await client.printMail.v1.orderProfiles.selfMailers.create(
   *     { size: '8.5x11_bifold' },
   *   );
   * ```
   */
   ...
   * ```ts
   * const selfMailer =
   *   await client.printMail.v1.orderProfiles.selfMailers.retrieve(
   *     'id',
   *   );
   * ```
   */
   ...
   * ```ts
   * const selfMailer =
   *   await client.printMail.v1.orderProfiles.selfMailers.update(
   *     'id',
   *     { size: '8.5x11_bifold' },
   *   );
   * ```
   ...
   * for await (const selfMailerListResponse of client.printMail.v1.orderProfiles.selfMailers.list()) {
   *   // ...
   * }
   * ```
   */
   ...
   * ```ts
   * const selfMailer =
   *   await client.printMail.v1.orderProfiles.selfMailers.delete(
   *     'id',
   *   );
   * ```
   */
