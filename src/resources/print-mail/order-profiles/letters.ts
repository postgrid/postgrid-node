...
export class Letters extends APIResource {
  ...
  create(params: LetterCreateParams, options?: RequestOptions): APIPromise<LetterProfile> {
    ...
    return this._client.post('/print-mail/v1/order_profiles/letters', { query: { expand }, body, ...options });
  }
   ...
   * ```
   */
  retrieve(id: string, query: LetterRetrieveParams | null | undefined = {}, options?: RequestOptions): APIPromise<LetterProfile> {
  ...
  update(id: string, params: LetterUpdateParams, options?: RequestOptions): APIPromise<LetterProfile> {
    const { expand, ...body } = params
    return this._client.post(path`/print-mail/v1/order_profiles/letters/${id}`, { query: { expand }, body, ...options });
  }
   ...
   * ```
   */
  list(query: LetterListParams | null | undefined = {}, options?: RequestOptions): PagePromise<LetterProfilesSkipLimit, LetterProfile> {
    return this._client.getAPIList('/print-mail/v1/order_profiles/letters', SkipLimit<LetterProfile>, { query, ...options });
  }
