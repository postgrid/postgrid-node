...
> {
  const parsed = safeParse(
    request,
    (value) => components.ChequeCreate$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, components.Cheque$inboundSchema),
