 ...
 */
export function postcardsCreate(
  client: PostGridCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => components.PostcardCreate$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/postcards")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, components.Postcard$inboundSchema),
