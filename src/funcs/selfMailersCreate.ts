 ...
 */
export function selfMailersCreate(
  client: PostGridCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => components.SelfMailerCreate$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/self-mailers")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, components.SelfMailer$inboundSchema),
