...
- <code><a href="./src/resources/print-mail/bank-accounts.ts">BankAccountListResponse</a></code>
...
- <code title="get /print-mail/v1/bank_accounts">client.printMail.bankAccounts.<a href="./src/resources/print-mail/bank-accounts.ts">list</a>({ ...params }) -> BankAccountListResponse</code>
...
- <code title="get /print-mail/v1/boxes">client.printMail.boxes.<a href="./src/resources/print-mail/boxes.ts">list</a>({ ...params }) -> BoxListResponse</code>
...
- <code><a href="./src/resources/print-mail/campaigns.ts">CampaignListResponse</a></code>
...
- <code title="get /print-mail/v1/campaigns">client.printMail.campaigns.<a href="./src/resources/print-mail/campaigns.ts">list</a>({ ...params }) -> CampaignListResponse</code>
...
- <code><a href="./src/resources/print-mail/cheques.ts">ChequeListResponse</a></code>
...
- <code title="get /print-mail/v1/cheques">client.printMail.cheques.<a href="./src/resources/print-mail/cheques.ts">list</a>({ ...params }) -> ChequeListResponse</code>
...
- <code><a href="./src/resources/print-mail/contacts.ts">ContactListResponse</a></code>
...
- <code title="get /print-mail/v1/contacts">client.printMail.contacts.<a href="./src/resources/print-mail/contacts.ts">list</a>({ ...params }) -> ContactListResponse</code>
...
- <code><a href="./src/resources/print-mail/letters.ts">LetterListResponse</a></code>
...
- <code title="get /print-mail/v1/letters">client.printMail.letters.<a href="./src/resources/print-mail/letters.ts">list</a>({ ...params }) -> LetterListResponse</code>
...
- <code><a href="./src/resources/print-mail/mailing-list-imports.ts">MailingListImportListResponse</a></code>
...
- <code title="get /print-mail/v1/mailing_list_imports">client.printMail.mailingListImports.<a href="./src/resources/print-mail/mailing-list-imports.ts">list</a>({ ...params }) -> MailingListImportListResponse</code>
...
- <code><a href="./src/resources/print-mail/mailing-lists.ts">MailingListListResponse</a></code>
...
- <code title="get /print-mail/v1/mailing_lists">client.printMail.mailingLists.<a href="./src/resources/print-mail/mailing-lists.ts">list</a>({ ...params }) -> MailingListListResponse</code>
...
- <code title="get /print-mail/v1/order_profiles/cheques">client.printMail.orderProfiles.cheques.<a href="./src/resources/print-mail/order-profiles/cheques.ts">list</a>({ ...params }) -> ChequeListResponse</code>
...
- <code><a href="./src/resources/print-mail/order-profiles/letters.ts">LetterListResponse</a></code>
...
- <code title="get /print-mail/v1/order_profiles/letters">client.printMail.orderProfiles.letters.<a href="./src/resources/print-mail/order-profiles/letters.ts">list</a>({ ...params }) -> LetterListResponse</code>
...
- <code><a href="./src/resources/print-mail/order-profiles/postcards.ts">PostcardListResponse</a></code>
...
- <code title="get /print-mail/v1/order_profiles/postcards">client.printMail.orderProfiles.postcards.<a href="./src/resources/print-mail/order-profiles/postcards.ts">list</a>({ ...params }) -> PostcardListResponse</code>
...
- <code><a href="./src/resources/print-mail/order-profiles/self-mailers.ts">SelfMailerListResponse</a></code>
...
- <code title="get /print-mail/v1/order_profiles/self_mailers">client.printMail.orderProfiles.selfMailers.<a href="./src/resources/print-mail/order-profiles/self-mailers.ts">list</a>({ ...params }) -> SelfMailerListResponse</code>
...
- <code><a href="./src/resources/print-mail/postcards.ts">PostcardListResponse</a></code>
...
- <code title="get /print-mail/v1/postcards">client.printMail.postcards.<a href="./src/resources/print-mail/postcards.ts">list</a>({ ...params }) -> PostcardListResponse</code>
...
- <code><a href="./src/resources/print-mail/self-mailers.ts">SelfMailerListResponse</a></code>
...
- <code title="get /print-mail/v1/self_mailers">client.printMail.selfMailers.<a href="./src/resources/print-mail/self-mailers.ts">list</a>({ ...params }) -> SelfMailerListResponse</code>
...
- <code><a href="./src/resources/print-mail/templates.ts">TemplateListResponse</a></code>
...
- <code title="get /print-mail/v1/templates">client.printMail.templates.<a href="./src/resources/print-mail/templates.ts">list</a>({ ...params }) -> TemplateListResponse</code>
